...
class ContainerGridViewBuilder extends StatefulWidget {
  ContainerGridViewBuilder({required this.heightGridView,
...
class _ContainerGridViewBuilderState extends State<ContainerGridViewBuilder> {
  ...
  didChangeDependencies() {
    ...
    isErrorManuallyEnteredCurrencyPair =
    enteredCurrencyPairMap['isErrorEnteredText'];
  ...
  double getInitialScrollOffset() {
    ...
    /// a map that contains:
    /// 1. the currently entered currency pair
    /// 2. a boolean that signals whether the entered currency pair is valid
    Map<String, dynamic> enteredCurrencyPairMap = dataProvider!
        .getEnteredTextCurrencyPair();
    ...
    print(
        "isErrorManuallyEnteredCurrencyPair: $isErrorManuallyEnteredCurrencyPair");
    ...
    manuallyEnteredCurrencyPair != null &&
      ...
      /// row number of the manually entered currency pair
      int rowManuallyEnteredCurrencyPair = dataProvider!
          .getCurrentlySelectedInstrumentRowNumber();

      double scaleOffset = (rowManuallyEnteredCurrencyPair - 1) * (
  ...
  Container build(BuildContext context) {
    ...
    print(
        "manuallyEnteredCurrencyPair: ${manuallyEnteredCurrencyPair}, isErrorManuallyEnteredCurrencyPair: $isErrorManuallyEnteredCurrencyPair");

    print("crossAxisSpacing: ${widget.crossAxisSpacing}");
    print("mainAxisSpacing: ${widget.mainAxisSpacing}");
    print("childAspectRatio: ${widget.aspectRatioGridTile}");
    ...
    GridView gridViewBuilder = GridView.builder(
      ...
      //   mainAxisExtent: widget.heightGridTile,
      //   maxCrossAxisExtent: widget.widthGridTile,
      //   mainAxisSpacing: widget.mainAxisSpacing,
      //   crossAxisSpacing: widget.crossAxisSpacing,
      //   // childAspectRatio: widget.aspectRatioGridTile,
      //
      ...
      itemBuilder: (context, index) {
        ...
        if (currentInstrumentsData.runtimeType != String) {
          ...
          try {
            ...
            bool isCurrentPriceLongerThanOldPrice = current_price!.length >
                old_price!.length;
            ...
            if (isCurrentPriceLongerThanOldPrice &&
                current_price.contains(".")) {
              longestStringOldCurrentPrice = current_price;
              indexOfDot = current_price.indexOf(".");
              numDecimalNumbersLongestPriceString = current_price
                  .substring(indexOfDot + 1)
                  .length;
            } else
            if (!isCurrentPriceLongerThanOldPrice && old_price.contains(".")) {
              longestStringOldCurrentPrice = old_price;
              indexOfDot = old_price.indexOf(".");
              numDecimalNumbersLongestPriceString = old_price
                  .substring(indexOfDot + 1)
                  .length;
            }
            ...
            print("");
            print(
                "longestStringOldCurrentPrice: $longestStringOldCurrentPrice");
            print("indexOfDot: $indexOfDot");
            print(
                "numDecimalNumbersLongestPriceString: $numDecimalNumbersLongestPriceString");
